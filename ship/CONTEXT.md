...
| Generate a binary file deliverable | project-approved local tool or skill for the target format | unrelated skills |
...
- **File deliverables** (PDFs, Word docs, slide decks) use project-approved local tools or skills. Source-available document skill bundles are not tracked in the public scaffold.
