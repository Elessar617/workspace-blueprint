...
Replace this note with domain-specific terms that agents need to understand.
Without this, the planner and implementer will use generic synonyms that do not
match your codebase's vocabulary.
